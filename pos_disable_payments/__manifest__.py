...

{
    ...
    "price": 20,
    "currency": 'EUR',
    "depends": ['base', 'point_of_sale', 'pos_hr','pos_restaurant','pos_discount'],
    "data": [
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            ('replace', 'pos_restaurant/static/src/overrides/components/product_screen/actionpad_widget/actionpad_widget.xml', 'pos_disable_payments/static/src/xml/restuarant_actionpad.xml'),
            ('replace', 'pos_discount/static/src/overrides/components/control_buttons/control_buttons.xml', 'pos_disable_payments/static/src/xml/control_button.xml'),
        ],
    },
    "auto_install": False,
    "installable": True,
